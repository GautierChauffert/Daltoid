...
public class UtilityAction
{
	...
	public void Start(MovementController ctr)
	{
		if(this.action != null) {
			...
			this.isRunning = true;
			ctr.entity.StartCoroutine(this.coroutine);
		}
	}

	public void Stop(MovementController ctr)
	{
		if(this.action != null) {
		...
		ctr.entity.StopCoroutine(this.coroutine);
	}
